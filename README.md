...
A variation on theme _what if [karpathy/micrograd](https://github.com/karpathy/micrograd) was written
by a functional programmer_.

## Key differences

1. Operation-specific immutable classes via `typing.Final` and `@dataclass`
